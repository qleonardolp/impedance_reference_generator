...
#ifndef ROBOT_IMPEDANCE_ANALYZER__QUADRUPED_CONTROL_HPP_
#define ROBOT_IMPEDANCE_ANALYZER__QUADRUPED_CONTROL_HPP_
...
#include <robot_impedance_analyzer/quadruped_control_parameters.hpp>
 ...
 */
class QuadrupedControl : public rclcpp_lifecycle::LifecycleNode
{
public:
  explicit QuadrupedControl(const std::string & node_name, bool intra_process_comms = false);
  ...
  /**
   * @brief Gait Pattern Modulator callback
   */
  void gait_callback();
...
private:
  ...
  std::shared_ptr<rclcpp::Publisher<KinematicPose>> fl_publisher_;  // front left publisher
  std::shared_ptr<rclcpp::Publisher<KinematicPose>> fr_publisher_;  // front right publisher
  std::shared_ptr<rclcpp::Publisher<KinematicPose>> rl_publisher_;  // rear left publisher
  std::shared_ptr<rclcpp::Publisher<KinematicPose>> rr_publisher_;  // rear right publisher

  KinematicPose fl_msg_;
  KinematicPose fr_msg_;
  KinematicPose rl_msg_;
  KinematicPose rr_msg_;
...
#endif  // ROBOT_IMPEDANCE_ANALYZER__QUADRUPED_CONTROL_HPP_
